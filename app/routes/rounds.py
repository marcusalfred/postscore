...
from models import Round, RoundHole, RoundRequest, RoundPatchRequest, RoundResponse, RoundHoleRequest, RoundHoleResponse, RoundHolePatchRequest
...
async def update_round(round_id: int, data: RoundPatchRequest):
    db = SessionLocal()
    try:
